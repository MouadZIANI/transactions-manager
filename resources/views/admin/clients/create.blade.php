...
@section('page-title')
	<h1 class="page-title"><i class="fe fe-plus-circle"></i> Nouveau client</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="tel" name="phone_number" class="form-control {{ $errors->has('phone_number') ? ' is-invalid' : '' }}" placeholder="N°. Telephone" value="{{ old('phone_number') }}">
